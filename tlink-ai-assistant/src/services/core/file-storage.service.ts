...
export class FileStorageService {
     ...
     * Format: {APPDATA}/tlink/plugins/tlink-ai-assistant/data
     */
    getPluginDataDirectory(): string {
        const baseDir = process.env.APPDATA ||
                       process.env.HOME ||
                       process.cwd();
        return this.joinPath(baseDir, 'tlink', 'plugins', 'tlink-ai-assistant', 'data');
    }
    ...
    migrateFromLocalStorage(): string[] {
        ...
        // Define localStorage keys and corresponding file names to migrate
