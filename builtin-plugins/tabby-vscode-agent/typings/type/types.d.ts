 ...
 */
export declare function createSuccessResponse(text: string, metadata?: Record<string, any>): McpResponse;
/**
 * JSON response helper
 */
export declare function createJsonResponse(data: any): McpResponse;
/**
 * Error response helper
 */
export declare function createErrorResponse(errorMessage: string): McpResponse;
/**
