...
import { TerminalDecorator, BaseTerminalTabComponent, XTermFrontend, SessionMiddleware } from 'tlink-terminal'
import { SSHProfile, SSHTabComponent, PasswordStorageService } from 'tlink-ssh'
...
export class AutoSudoPasswordMiddleware extends SessionMiddleware {
    ...
    private pasteHint = `${colors.black.bgBlackBright(' Tlink ')} ${colors.gray('Press Enter to paste saved password')}`
